...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/kececicurve/issues)
...
* The kececicurve version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/kececicurve/issues) for any
...
Ready to contribute? Here's how to set up kececicurve for local development.
...
2. Create your own fork of the kececicurve [repository](https://github.com/WhiteSymmetry/kececicurve).
3. Clone your repository, for example by typing in your terminal:
`git clone https://github.com/<your_username>/kececicurve.git`.
4. Install `kececicurve` as editable in your new environment:
...
Please note that the kececicurve project is released with a
